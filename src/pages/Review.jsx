...
export default function Reviews() {
	return (
		<>
			<main className='main-section flex flex-col gap-14 items-center mt-16 px-4'>
				<div className='flex flex-col gap-8 items-center'>
					<h2 className='text-3xl md:text-4xl lg:text-6xl text-white font-semibold tracking-tight text-center'>
				...
				<section className='review-cards flex flex-wrap gap-6 my-8 justify-center px-4 md:px-6'>
					<ReviewCard
						name='Sarah Taranian'
