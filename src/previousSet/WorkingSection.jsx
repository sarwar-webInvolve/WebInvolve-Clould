		...
		<section className='w-full bg-[rgb(5,7,26)] shadow-[inset_0_0_80px_rgba(59,130,246,0.25)] text-white py-24 px-12'>
			<div className='max-w-7xl mx-auto'>
				...
				<div className='grid lg:grid-cols-2 gap-16 items-center'>
					...
					<div className='relative rounded-3xl bg-linear-to-br bg-[rgb(5,7,26)] shadow-[inset_0_0_80px_rgba(59,130,246,0.25)]  px-20 py-10  border border-blue-900/40 '>
						{/* Image Placeholder */}
						<div className='w-full h-87.5 rounded-2xl  flex items-center justify-center text-gray-500 text-lg border border-blue-800/40'>
					...
					<div>
						<h3 className='text-4xl md:text-4xl font-semibold leading-tight'>
			...
			<div className='grid lg:grid-cols-2 gap-16 px-12 items-center mt-32'>
				...
				<div className='relative rounded-3xl bg-linear-to-br bg-[rgb(5,7,26)] shadow-[inset_0_0_80px_rgba(59,130,246,0.25)] p-20 border border-blue-900/40'>
					<div className='w-full h-87.5 rounded-2xl flex items-center justify-center text-gray-500 text-lg border border-blue-800/40'>
